...
if __name__ == '__main__':
    ...
    chatHeader = ['assignmentid','workerid','gameid','epoch-time','contents']
    ...
    stateHeader = ['gameid','time','roundNum','condition','clickStatus',
                    'clickColH','clickColS','clickColL','clickLocS',
                    'clickLocL','alt1Status','alt1ColH','alt1ColS','alt1ColL',
                    'alt1LocS','alt1LocL','alt2Status','alt2ColH','alt2ColS',
                    'alt2ColL','alt2LocS','alt2LocL','targetD1Diff',
    ...
    COLORSjsonToCSV(swapHeader, CLICKED_IN_FILE, CLICKED_OUT_FILE, False)
    COLORSjsonToCSV(stateHeader, CLICKED_IN_FILE, CLICKED_OUT_FILE, False)
